                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex flex-wrap items-center gap-6">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button onClick={() => navigate('/truck-booking-details', { state: { selectedResult: offer, originalFormData: formData } })} className="flex items-center gap-2 bg-brand-gradient hover:opacity-90 text-white font-bold py-3 px-5 rounded-xl transition text-sm whitespace-nowrap">
